...
* Click the AppsAnywhere icon, scroll down to "R for windows" and click launch. 
...
> **Challenge 5**
>
> Library load the following packages: `ggplot2`, `dplyr`, `palmerpenguins`
