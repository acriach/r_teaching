...
One of the more effective ways to work with R is to start by writing the code you want to run directly in an .R script. You then run the selected lines (by either using a keyboard shortcut or clicking the "Run" button) in the R console.
...
>
> 1. In the window showing the data, save the data as a file (CTRL + S or right mouse click > "Save as")
