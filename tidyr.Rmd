...
To demonstrate `separate()` we will first create the messy data set in the Challenge above using the combine `c()` function. (You may notice AI creating small example data frames (df) in this way.)
...
<details>
  <summary>**Your data from doing Challenge 2 should look like this**</summary>

```{r, echo=FALSE, eval = TRUE}
result <- pivot_longer(people_heights_wide, 
  cols = c(child, adult),    
  names_to = "age", 
  values_to = "height"
)
